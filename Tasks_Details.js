...
const people = [
    { id: "priority1", name: "Arun", email: "arun@example.com", capacityHrsPerDay: 6 },
    { id: "priority2", name: "Uma", email: "uma@", capacityHrsPerDay: 5 }, // invalid email
...
const todos = [
    ...
    { id: "t1", title: "Setup repo", estimateHrs: 2, priority: "high", status: "done", due: "2025-09-16", assigneeId: "priority1" },
    { id: "t2", title: "Scaffold UI", estimateHrs: 5, priority: "high", status: "in-progress", due: "2025-09-18", assigneeId: "priority1", dependsOn: ["t1"] },
    { id: "t3", title: "Build login", estimateHrs: 8, priority: "medium", status: "todo", due: "2025-09-20", assigneeId: "priority2" },
    { id: "t4", title: "Payments integration", estimateHrs: 13, priority: "high", status: "todo", due: "2025-09-19", assigneeId: "priority2", dependsOn: ["t3"] },
    ...
    { id: "t9", title: "Build login", estimateHrs: 8, priority: "medium", status: "todo", due: "2025-09-20", assigneeId: "priority2" }, // duplicate title
    { id: "t10", title: "Refactor utils", estimateHrs: 3, priority: "low", status: "done", due: "2025-09-14", assigneeId: "priority1" }, // done but due in past
    { id: "t11", title: "Release v1", estimateHrs: 6, priority: "high", status: "blocked", due: "2025-09-22", assigneeId: "priority2", dependsOn: ["t4", "t6"] },
...
class TodosDetails {
    ...
    findPriority() {
        ...
        readyTasks.sort((a, b) => {
            const priority1 = priorityRank[a.priority];
            const priority2 = priorityRank[b.priority];
